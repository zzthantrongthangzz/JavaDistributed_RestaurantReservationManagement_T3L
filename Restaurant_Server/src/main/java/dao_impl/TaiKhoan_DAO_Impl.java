...
public class TaiKhoan_DAO_Impl extends UnicastRemoteObject implements ITaiKhoan_DAO {

    public TaiKhoan_DAO_Impl() throws RemoteException {
        super();
    }

    // Các hàm Hash và Kiểm tra Hash giữ nguyên (Có thể viết trong Interface hoặc Helper)
    ...
    public boolean guiEmailXacThuc(String email, String maXacThuc, String tenDangNhap) throws RemoteException {
        try {
            ...
            String password = "occx ilgk angk gaqk"; // Nên dùng biến môi trường để bảo mật
