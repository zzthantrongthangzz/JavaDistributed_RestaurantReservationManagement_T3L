...
public class CapNhatKhachHang_UI extends JPanel {
    ...
    private void taiDuLieuLenBang() {
        if (khachHangService == null) return;
        SwingWorker<List<KhachHang>, Void> worker = new SwingWorker<List<KhachHang>, Void>() {
            ...
            protected List<KhachHang> doInBackground() throws Exception {
                return khachHangService.docDanhSachKhachHang();
            }
            @Override
            protected void done() {
                try {
        ...
        SwingWorker<List<KhachHang>, Void> worker = new SwingWorker<List<KhachHang>, Void>() {
            ...
            protected List<KhachHang> doInBackground() throws Exception {
                if (tuKhoa.toUpperCase().startsWith("KH")) {
                    return khachHangService.timKiemTheoMa(tuKhoa);
                } else if (tuKhoa.matches("\\d+")) {
                    return khachHangService.timKiemTheoSDT(tuKhoa);
                } else {
                    return khachHangService.timKiemTheoTen(tuKhoa);
                }
            }
            @Override
            protected void done() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
                ...
                protected Boolean doInBackground() throws Exception {
                    return khachHangService.capNhatKhachHang(kh);
                }
                @Override
                protected void done() {
    ...
    private void xoaKhachHang() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            ...
            SwingWorker<Boolean, Void> worker = new SwingWorker<Boolean, Void>() {
                @Override
                protected Boolean doInBackground() throws Exception {
                    return khachHangService.xoaKhachHang(maKH);
                }
                @Override
                protected void done() {
    ...
    private void thucHienSapXep(int loaiSapXep) {
        ...
        SwingWorker<List<KhachHang>, Void> worker = new SwingWorker<List<KhachHang>, Void>() {
            ...
            protected List<KhachHang> doInBackground() throws Exception {
                switch (loaiSapXep) {
                    case 1: return khachHangService.sapXepTheoTen(true);
                    case 2: return khachHangService.sapXepTheoTen(false);
                    case 3: return khachHangService.sapXepTheoDiem(false);
                    case 4: return khachHangService.sapXepTheoDiem(true);
                    default: return khachHangService.docDanhSachKhachHang();
                }
            }
            @Override
            protected void done() {
        ...
        SwingWorker<List<KhachHang>, Void> worker = new SwingWorker<List<KhachHang>, Void>() {
            ...
            protected List<KhachHang> doInBackground() throws Exception {
                if (gioiTinhStr.equals("Lọc giới tính")) {
                    ...
                    return khachHangService.locKhachHangTheoGioiTinh(isNam);
                }
            }
            @Override
            protected void done() {
    ...
    private void hienThiDialogKhachHangDaXoa() {
        ...
        btnPhucHoi.addActionListener(e -> {
            ...
            if (confirm == JOptionPane.YES_OPTION) {
                ...
                SwingWorker<Boolean, Void> resWorker = new SwingWorker<Boolean, Void>() {
                    @Override
                    protected Boolean doInBackground() throws Exception {
                        return khachHangService.khoiPhucKhachHang(maKH);
                    }
                    @Override
                    protected void done() {
        ...
        SwingWorker<List<KhachHang>, Void> loadWorker = new SwingWorker<List<KhachHang>, Void>() {
            @Override
            protected List<KhachHang> doInBackground() throws Exception {
                return khachHangService.getKhachHangDaXoa();
            }
            @Override
            protected void done() {
                try {
