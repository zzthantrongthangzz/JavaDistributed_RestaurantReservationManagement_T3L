...
public interface IKhuyenMai_Service extends Remote {
    ...
    public List<dto.ThongKeKhuyenMaiDTO> getThongKeChiTietKhuyenMai(Date tuNgay, Date denNgay) throws RemoteException;
}