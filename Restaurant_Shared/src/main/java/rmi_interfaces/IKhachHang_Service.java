...
public interface IKhachHang_Service extends Remote {
    ...
    public List<dto.ThongKeKhachHangDTO> getTopKhachHangDayDu(int topN, Date tu, Date den) throws RemoteException;
